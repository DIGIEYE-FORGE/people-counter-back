...
const { authorize, ADMIN, SYSADMIN } = require('../../middlewares/auth');
const {
  listConfig,
  updateConfig,
  deleteConfig,
...
router.param('configId', controller.load);

router
  .route('/')
  /**
   * @api {get} v1/device-groups List Device Groups
   * @apiDescription Get a list of device-groups
   * @apiVersion 1.0.0
   ...
   */
  .get(authorize([ADMIN, SYSADMIN]), validate(listConfig), controller.list)
  /**
...
router
   ...
   */
  .get(authorize([ADMIN, SYSADMIN]), controller.get)
  /**
